            ...
            <form action="{{ route('pokemon.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-6 ">
                        ...
                        <input class="form-control @error('species') is-invalid @enderror" name="species" type="text" id="species" value="{{old('species')}}">
                    </div>
                    <div class="col-6">
                    ...
                    <div class="col-6 ">
                        ...
                        <input class="form-control @error('weight') is-invalid @enderror" name="weight" type="number" id="weight" step="any" value="{{old('weight')}}">
                    </div>
                    <div class="col-6 ">
                        <label class="form-label" for="height">Height (m)</label>
                        <input class="form-control @error('height') is-invalid @enderror" name="height" type="number" id="height" step="any" value="{{old('height')}}">
                    </div>
                    <div class="col-6">
                        <label class="form-label" for="hp">HP</label>
                        <input class="form-control @error('hp') is-invalid @enderror" name="hp" type="number" id="hp" value="{{old('hp')}}">
                    </div>
                    <div class="col-6">
                        <label class="form-label" for="attack">Attack</label>
                        <input class="form-control @error('attack') is-invalid @enderror" name="attack" type="number" id="attack" value="{{old('attack')}}">
                    </div>
                    <div class="col-6">
                        <label class="form-label" for="defense">Defense</label>
                        <input class="form-control @error('defense') is-invalid @enderror" name="defense" type="number" id="defense" value="{{old('defense')}}">
                    </div>
                    <div class="col-6">
